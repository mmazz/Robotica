...
"""autogenerated by genpy from robmovil_msgs/Trajectory.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import robmovil_msgs.msg
...
class Trajectory(genpy.Message):
  ...
  _type = "robmovil_msgs/Trajectory"
...
"""
  ...
  _slot_types = ['std_msgs/Header','robmovil_msgs/TrajectoryPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = robmovil_msgs.msg.TrajectoryPoint()
        _v11 = val1.transform
